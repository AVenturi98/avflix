        ...
        <Link to={`/${type}/${id}` + '-' + titleSlug(title || name)} onMouseEnter={onMouseEnter}>
            <div className='img_popular_card'>
                <div className={`${styleCard} shadow-card rounded-2xl`}>
                    <LazyLoader image={image !== null ? image : '/placeholder/moviesPlaceholder.png'} style={`${styleImg} rounded-2xl relative`} />
                    ...
                    {image === '/placeholder/moviesPlaceholder.png' && mobileWidth && !media_name ?
