            ...
            {myArray.length >= 1 ?
                <section className="filtered-genres-container">
                    <div className="filtered-genres-content flex-col sm:gap-3 sm:mb-10">
                        <div className='filtered-genres-title flex items-center gap-8 sm:gap-16'>
                            <h2 className='px-2 filtered-genres-title text-2xl sm:text-4xl font-bold mt-6'>{title}</h2>
                            {viewmorePerson ?
